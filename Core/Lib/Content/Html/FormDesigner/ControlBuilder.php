    ...
    private function buildFormAbstract()
    {
        ...
        if ($this->control->hasLabel() && ! $this->control instanceof Checkbox) {
            ...
            if ($this->display_mode == 'h') {
                $this->control->label->addCss('col-sm-2');
            }
        ...
        // Build control
        $this->control_html = $this->display_mode == 'h' && $this->control->hasLabel() ? '<div class="col-sm-10">' . $this->control->build() . '</div>' : $this->control->build();
