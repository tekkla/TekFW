...
class DateTimePicker extends Input
{
    ...
    {
        return $this->txt('lang_dictonary');
    }
    ...
    private function loadTranslation()
    {
        ...
        if ($this->option_language != 'en')
            $this->js->file($this->cfg->get('Core', 'url_js') . '/locale/moment/' . $this->option_language . '.js');
